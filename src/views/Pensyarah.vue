    ...
    <div class="bg-gradient-to-br from-blue-50 to-cyan-100 min-h-screen pb-8">
        ...
        >
            <div class="relative w-full max-w-full mx-auto">
                ...
                <button
                    class="absolute left-2 sm:-left-6 top-1/2 -translate-y-1/2 z-30 bg-white border-2 border-blue-200 shadow-lg p-2 rounded-full hover:bg-blue-200 transition text-sm flex items-center justify-center"
                ...
                <button
                    class="absolute right-2 sm:-right-6 top-1/2 -translate-y-1/2 z-30 bg-white border-2 border-blue-200 shadow-lg p-2 rounded-full hover:bg-blue-200 transition text-sm flex items-center justify-center"
                ...
                >
                    ...
                    >
                        <div class="w-full mb-2">
                            <div
                                class="font-extrabold text-sm text-blue-900 flex items-center gap-2 leading-tight break-words whitespace-normal"
                            >
                                <span>👨‍🏫</span>
                                <span
                        ...
                        <span
                            ...
                            class="absolute top-5 right-5 text-sm animate-bounce"
