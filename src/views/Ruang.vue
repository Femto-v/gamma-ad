...
// Only show up to loadCount
const visibleRooms = computed(() => filteredRooms.value.slice(0, loadCount.value));
      ...
      <div class="flex flex-col items-center">
        ...
        >
          ...
          >
            ...
            <!-- Bottom Info Row -->
            <div class="flex justify-between items-center mt-3 text-[15px] flex-wrap">
