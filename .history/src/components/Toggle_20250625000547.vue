...
<template>
    ...
    <header
        :class="[
            'fixed top-0 left-0 z-20 w-full p-3 flex justify-between items-center transition-colors duration-300',
            isScrolled
    ...
    >
        <div
            class="p-4 border-b border-blue-200 bg-gradient-to-br from-blue-200/70 via-white/80 to-blue-100 flex justify-between items-center"
        >
            <h2
        ...
        <nav class="flex flex-col p-3 text-base font-semibold gap-4">
            <a
                href="#"
