    ...
    <div class="bg-gradient-to-br from-blue-50 to-cyan-100 min-h-screen pb-8">
        ...
        >
            <div class="relative w-full max-w-full mx-auto">
                <!-- Carousel navigation -->
                <button
                    class="absolute left-1 top-1/2 -translate-y-1/2 z-10 bg-white border-2 border-blue-200 shadow p-2 rounded-full hover:bg-blue-50 transition text-lg"
                ...
                >
                    ...
                    >
                        <div class="flex flex-col gap-1 w-full">
                            <div
                                class="font-bold text-lg text-blue-800 flex items-center gap-1"
                            >
                                👤
                                <span class="truncate" :title="student.name">{{
                                    student.name
                                }}</span>
                            </div>
                            <div
                        ...
                        <button
                            class="absolute bottom-3 right-3 rounded-2xl bg-gradient-to-tr from-blue-300 via-blue-400 to-blue-600 text-white font-bold text-xs px-4 py-1.5 shadow-md hover:from-pink-400 hover:to-blue-700 transition active:scale-95 flex items-center gap-1"
                ...
                <button
                    class="absolute right-1 top-1/2 -translate-y-1/2 z-10 bg-white border-2 border-blue-200 shadow p-2 rounded-full hover:bg-blue-50 transition text-lg"
