...
<template>
    <div
        v-if="show"
        class="fixed inset-0 bg-white/30 backdrop-blur-sm bg-opacity-50 z-50 flex justify-center items-center"
    >
        <div
...
<style scoped>
/* Optional: smooth fade-in/out transitions can be added here */
</style>
