...
<template>
    <div class="bg-transparent min-h-screen">
        ...
        <div
            v-if="!isLoading"
            class="w-full flex flex-col items-center justify-center px-0 mt-4 relative"
            style="min-height: 320px"
        >
            <!-- Overlay gradients (absolute, pointer-events-none so user can scroll) -->
            <div
                class="pointer-events-none absolute z-10 left-1/2 -translate-x-1/2 top-0 w-[98vw] max-w-[290px] h-7 bg-gradient-to-b from-white/80 via-white/20 to-transparent"
            ></div>
            <div
                class="pointer-events-none absolute z-10 left-1/2 -translate-x-1/2 bottom-0 w-[98vw] max-w-[290px] h-7 bg-gradient-to-t from-white/80 via-white/20 to-transparent"
            ></div>
            ...
            <div
                ref="sliderRef"
                class="flex flex-col gap-2 overflow-y-auto snap-y snap-mandatory no-scrollbar relative student-list-area"
                style="
                    height: 230px;
                    max-height: 55vh;
                    min-height: 180px;
                    ...
                    :style="{
                        transform:
                            currentIndex.value === idx
                                ? 'scale(1.04)'
                                : 'scale(1)',
                        zIndex: currentIndex.value === idx ? 2 : 1,
                    }"
                >
                    <div
