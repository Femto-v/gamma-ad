    ...
    <div class="bg-gradient-to-br from-blue-50 to-cyan-100 min-h-screen pb-8">
        ...
        >
            <div class="relative w-full max-w-full mx-auto">
                <!-- Carousel navigation -->
                <button
                    class="absolute left-[-28px] top-1/2 -translate-y-1/2 z-20 bg-white border-2 border-blue-200 shadow-lg p-3 rounded-full hover:bg-blue-100 transition text-xl flex items-center justify-center"
                ...
                <button
                    class="absolute right-[-28px] top-1/2 -translate-y-1/2 z-20 bg-white border-2 border-blue-200 shadow-lg p-3 rounded-full hover:bg-blue-100 transition text-xl flex items-center justify-center"
                ...
                <div
                    ref="sliderRef"
                    class="flex gap-4 overflow-x-auto snap-x snap-mandatory pb-8 pt-2 no-scrollbar"
                ...
                >
                    <!-- Left phantom padder -->
                    <div
                        :style="{ minWidth: 'calc(50vw - 115px)' }"
                        aria-hidden="true"
                    ></div>
                    ...
                    <div
                        ...
                        class="group bg-white bg-opacity-95 border-4 border-blue-200 hover:border-blue-400 rounded-3xl shadow-lg shadow-blue-100/40 backdrop-blur transition-all duration-300 w-[230px] min-w-[230px] max-w-[230px] h-[320px] p-5 flex flex-col relative"
                        :style="{
                            boxShadow:
                                currentIndex === idx
                                    ? '0 10px 30px 4px #60a5fa44'
                                    : '0 2px 10px 1px #60a5fa22',
                            borderWidth: currentIndex === idx ? '4px' : '2px',
                        }"
                    >
                        <div class="flex flex-col w-full gap-1 flex-1">
                            <div
                                class="font-bold text-lg text-blue-800 flex items-center gap-2 leading-snug break-words"
                            >
                                👤
                            ...
                            <div
                                class="text-[13px] mt-1 text-gray-700 flex flex-row gap-1 items-center"
                            >
                                🆔
                        ...
                        <button
                            class="absolute bottom-5 right-5 z-20 rounded-2xl bg-gradient-to-tr from-blue-400 via-blue-500 to-blue-700 text-white font-bold text-sm px-5 py-2 shadow-xl hover:scale-105 hover:from-pink-400 hover:to-blue-700 transition active:scale-95 flex items-center gap-1"
                        ...
                        <span
                            ...
                            class="absolute top-4 right-4 text-2xl animate-bounce"
                            title="Currently Selected"
                            >🌟</span
                        >
                    </div>

                    <!-- Right phantom padder -->
                    <div
                        :style="{ minWidth: 'calc(50vw - 115px)' }"
                        aria-hidden="true"
                    ></div>
