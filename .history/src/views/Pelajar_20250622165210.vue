...
<template>
    <div class="bg-transparent min-h-screen">
        ...
        >
            <!-- Gradient overlays -->
            <div class="gradient-overlay-top pointer-events-none"></div>
            <div class="gradient-overlay-bottom pointer-events-none"></div>
            ...
            <div
                ref="sliderRef"
                class="flex flex-col gap-2 overflow-y-auto snap-y snap-mandatory no-scrollbar relative"
                style="
                    height: 230px;
                    max-height: 55vh;
                    min-height: 180px;
            ...
            >
                <div
                    ...
                    :key="idx"
                    class="w-[92vw] max-w-[250px] min-w-[140px] h-[150px] snap-center bg-blue-100 rounded-xl shadow p-3 flex flex-col items-start relative transition-all duration-500 border border-blue-200 mx-auto"
                    :style="{
                        transform:
...
.gradient-overlay-top {
    position: absolute;
    top: 46px; /* below search/filter, adjust if needed */
    left: 0;
    right: 0;
    height: 38px;
    pointer-events: none;
    ...
    background: linear-gradient(
        to bottom,
        rgba(210, 236, 252, 0.85),
        rgba(210, 236, 252, 0.5) 50%,
        rgba(210, 236, 252, 0.01) 100%
    );
    /* For dark mode: tweak as needed */
}

.gradient-overlay-bottom {
    position: absolute;
    bottom: 38px; /* above Footer, adjust if needed */
    left: 0;
    right: 0;
    height: 38px;
    pointer-events: none;
