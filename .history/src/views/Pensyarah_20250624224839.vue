    ...
    <div class="bg-gradient-to-br from-blue-50 to-cyan-100 min-h-screen pb-8">
        ...
        >
            <div class="relative w-full max-w-full mx-auto">
                <!-- Carousel navigation -->
                <button
                    class="absolute -left-6 top-1/2 -translate-y-1/2 z-30 bg-white border-2 border-blue-200 shadow-lg p-3 rounded-full hover:bg-blue-200 transition text-2xl flex items-center justify-center"
                ...
                >
                    ...
                    >
                        <div class="w-full mb-2">
                            <div
                                class="font-extrabold text-[1.2rem] md:text-xl text-blue-900 flex items-center gap-2 leading-tight break-words whitespace-normal"
                            >
                                <span>👨‍🏫</span>
                                <span
...
<script setup>
// ...your existing script (no changes needed, keep all logic as before)
</script>
