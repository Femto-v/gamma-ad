...
<template>
    <div
        class="fixed inset-0 bg-black/30 z-50 flex items-center justify-center bg-transparent backdrop-blur-sm"
    >
        <div
            class="bg-white rounded-2xl shadow-2xl w-full max-w-xl p-5 relative m-4"
        >
            <button
