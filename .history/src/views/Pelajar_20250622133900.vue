...
<template>
    <div class="bg-transparent min-h-screen">
        ...
        <div v-if="!isLoading" class="w-full flex flex-col items-center px-0">
            <div class="relative w-full max-w-3xl mx-auto px-14 sm:px-20">
                <button
                    class="absolute left-4 top-1/2 -translate-y-1/2 z-10 bg-white/80 border shadow p-2 rounded-full hover:bg-blue-50 transition"
                    :disabled="currentIndex <= 0"
                    @click="prevCard"
                    style="box-shadow: 0 2px 8px rgba(30, 64, 175, 0.06)"
                >
                    <svg
                ...
                <div
                    ref="sliderRef"
                    class="flex gap-8 overflow-x-auto snap-x snap-mandatory pb-8 pt-4 px-2"
                ...
                >
                    <div
                        ...
                        :key="idx"
                        class="w-[325px] min-w-[325px] max-w-[325px] snap-center bg-blue-100 rounded-2xl shadow-md p-6 flex flex-col items-start relative transition-all duration-500 border border-blue-200"
                        :style="{
                            transform:
                                currentIndex === idx
                                    ? 'scale(1.03)'
                ...
                <button
                    class="absolute right-4 top-1/2 -translate-y-1/2 z-10 bg-white/80 border shadow p-2 rounded-full hover:bg-blue-50 transition"
...
<style scoped>
/* Remove horizontal scrollbar on webkit browsers */
::-webkit-scrollbar {
    display: none;
}
...
/* Ensure cards are not cropped at slider edges */
.snap-x {
