                ...
                >
                    ...
                    >
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button
                                class="rounded-full bg-blue-50 border border-blue-200 p-2 shadow hover:bg-blue-200 hover:shadow-lg hover:scale-110 active:bg-blue-300 text-blue-600 transition duration-200 outline-none focus-visible:ring-2 focus-visible:ring-blue-400"
