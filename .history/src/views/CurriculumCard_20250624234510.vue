<template>
    <div
        class="bg-white/90 border-2 gap-2 border-blue-200 rounded-3xl shadow-xl px-7 py-6 flex flex-col gap-2 relative group hover:scale-105 hover:shadow-2xl transition cursor-pointer overflow-hidden"
        @click="onShowDetail"
    >
        <!-- Top emoji border -->
        <div
