...
// Cards to display: [spacer, ...students]
const cardsToDisplay = computed(() => {
    return [{ spacer: true }, ...filteredStudents.value];
});
            ...
            <div class="relative w-full max-w-full mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div
                                class="font-semibold text-base mt-2 mb-2 w-full text-blue-900 leading-tight break-words whitespace-pre-line"
                                style="
                                    display: -webkit-box;
                                    -webkit-line-clamp: 2;
                            ...
                            <div
                                class="mb-2 text-base text-blue-800 font-medium"
                            >
                                {{ student.yearCourse }}
                            </div>
                            <div
                            ...
                            <button
                                class="absolute right-3 bottom-3 rounded bg-gray-200 hover:bg-gray-300 p-2"
                        ...
                        <div
                            v-else
                            class="w-[220px] min-w-[220px] max-w-[220px] h-[350px] snap-center"
                            style="opacity: 0"
                        ></div>
                    </template>
                </div>
