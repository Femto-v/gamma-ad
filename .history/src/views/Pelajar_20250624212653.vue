    ...
    <div class="bg-gradient-to-br from-blue-50 to-cyan-100 min-h-screen pb-8">
        ...
        >
            <div class="relative w-full max-w-full mx-auto">
                <!-- Carousel navigation -->
                <button
                    class="absolute -left-12 top-1/2 -translate-y-1/2 z-30 bg-white border-2 border-blue-200 shadow-lg p-3 rounded-full hover:bg-blue-200 transition text-xl flex items-center justify-center"
                ...
                <button
                    class="absolute -right-12 top-1/2 -translate-y-1/2 z-30 bg-white border-2 border-blue-200 shadow-lg p-3 rounded-full hover:bg-blue-200 transition text-xl flex items-center justify-center"
                    :disabled="currentIndex >= filteredStudents.length - 1"
                    @click="nextCard"
                    style="width: 48px; height: 48px; margin-right: 0"
                >
                    <span>➡️</span>
                </button>
                ...
                <div
                    class="pointer-events-none absolute left-0 top-0 w-28 h-full z-10 bg-gradient-to-r from-blue-50/80 via-white/20 to-transparent"
                ></div>
                <div
                    class="pointer-events-none absolute right-0 top-0 w-28 h-full z-10 bg-gradient-to-l from-blue-50/80 via-white/20 to-transparent"
                ></div>

                <div
                    ref="sliderRef"
                    class="flex gap-8 overflow-x-auto snap-x snap-mandatory pb-10 pt-3 no-scrollbar"
                ...
                >
                    ...
                    <div
                        :style="{ minWidth: 'calc(50vw - 140px)' }"
                        aria-hidden="true"
                    ></div>
                    ...
                    <div
                        ...
                        class="group bg-white bg-opacity-95 border-4 border-blue-200 hover:border-blue-400 rounded-3xl shadow-lg shadow-blue-100/50 transition-all duration-300 flex flex-col justify-between items-start relative"
                        :class="
                            currentIndex === idx
                    ...
                    >
                        ...
                        <div class="w-full mb-2">
                            <div
                                class="font-extrabold text-lg md:text-xl text-blue-900 flex items-center gap-2 leading-tight break-words whitespace-normal justify-between"
                            >
                                <span>👤</span>
                                <span
                        ...
                        <div class="w-full flex flex-col gap-2 mb-2">
                            <div
                                class="rounded-xl border border-blue-200 bg-blue-50/60 px-2 py-1 flex items-center gap-2 text-sm"
                            >
                                <span class="font-bold">🆔 Matriks:</span>
                                <span class="font-mono text-blue-800">{{
                                    student.no_matrik
                                }}</span>
                            </div>
                            <div
                                class="rounded-xl border border-violet-200 bg-violet-50/60 px-2 py-1 flex items-center gap-2 text-sm"
                            >
                                <span>🔖 KP:</span>
                                <span class="font-mono text-violet-700">{{
                                    student.no_kp || "-"
                                }}</span>
                            </div>
                            <div
                                class="rounded-xl border border-cyan-200 bg-cyan-50/70 px-2 py-1 flex items-center gap-2 text-sm"
                            >
                                <span>🎓 Year:</span>
                            ...
                            <div
                                class="rounded-xl border border-green-200 bg-green-50/60 px-2 py-1 flex items-center gap-2 text-sm"
                            >
                                <span>🏢 Faculty:</span>
                                <span class="font-semibold">{{
                                    student.faculty
                            ...
                            <div
                                class="rounded-xl border border-pink-200 bg-pink-50/60 px-2 py-1 flex items-center gap-2 text-sm"
                            >
                                <span>📖 Subjects:</span>
                                <span class="font-semibold">{{
                        ...
                        <!-- Jadual Button -->
                        <button
                            class="absolute bottom-7 right-7 z-30 rounded-xl bg-gradient-to-tr from-blue-400 via-blue-500 to-blue-700 text-white font-bold text-base px-6 py-2 shadow-lg hover:scale-105 hover:from-pink-400 hover:to-blue-700 transition active:scale-95 flex items-center gap-2"
                        ...
                        <span
                            ...
                            class="absolute top-5 right-6 text-2xl animate-bounce"
