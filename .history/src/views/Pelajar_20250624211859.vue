                ...
                >
                    ...
                    >
                        <div class="flex flex-col gap-2 w-full flex-1">
                            <div
                                class="font-extrabold text-xs text-blue-900 flex items-center gap-2 leading-snug break-words"
                        ...
                        <button
                            class="absolute bottom-6 right-6 text-xs z-30 rounded-xl bg-gradient-to-tr from-blue-400 via-blue-500 to-blue-700 text-white font-bold text-[15px] px-5 py-2 shadow-xl hover:scale-105 hover:from-pink-400 hover:to-blue-700 transition active:scale-95 flex items-center gap-2"
