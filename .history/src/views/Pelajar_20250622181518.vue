...
function scrollToCard(idx) {
    // Center card in vertical scroller
...
<template>
    <div class="bg-transparent min-h-screen">
        ...
        >
            <!-- Up Button -->
            <button
                class="mb-2 w-9 h-9 flex items-center justify-center bg-white/80 border shadow rounded-full hover:bg-blue-50 transition disabled:opacity-60"
            ...
            <div
                ref="sliderRef"
                class="flex flex-col gap-2 overflow-y-auto snap-y snap-mandatory no-scrollbar"
                style="
                    height: 280px;
                    max-height: 60vh;
                    min-height: 220px;
            ...
            >
                <div
                    ...
                    :key="idx"
                    class="w-[95vw] max-w-[300px] min-w-[160px] h-[190px] snap-center bg-blue-100 rounded-xl shadow p-4 flex flex-col items-start relative transition-all duration-500 border border-blue-200 mx-auto"
                    :style="{
                        transform:
            ...
            <!-- Down Button -->
            <button
                class="mt-2 w-9 h-9 flex items-center justify-center bg-white/80 border shadow rounded-full hover:bg-blue-50 transition disabled:opacity-60"
