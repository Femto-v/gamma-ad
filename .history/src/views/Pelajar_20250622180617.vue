        ...
        >
            ...
            >
                <div
                    ...
                    :key="idx"
                    class="student-card w-[92vw] border-3 max-w-[250px] min-w-[140px] h-[150px] snap-center bg-blue-100 rounded-xl shadow p-3 flex flex-col items-start relative transition-all duration-500 border border-blue-200 mx-auto"
                    :style="{
                        transform:
