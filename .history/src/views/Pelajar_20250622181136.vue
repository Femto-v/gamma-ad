        ...
        >
            ...
            >
                <div
                    ...
                    :key="idx"
                    class="student-card border-3 w-[92vw] max-w-[250px] min-w-[140px] h-[150px] snap-center bg-blue-100 rounded-xl shadow p-3 flex flex-col items-start relative transition-all duration-500 border border-blue-200 mx-auto"
                    :style="{
                        transform:
...
.student-card {
    /* Core mask-image: fade at top and bottom */
    ...
    /* For extra blur on the fade you can also use a filter: */
    /* filter: blur(0.5px); */
}
</style>
