            ...
            <div class="relative w-full max-w-full mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <button
                            class="m-4 px-1.5bottom-3 rounded-2xl bg-gradient-to-tr from-blue-300 via-blue-400 to-blue-600 text-white font-bold text-xs shadow-md hover:from-pink-400 hover:to-blue-700 transition active:scale-95 flex items-center gap-1"
