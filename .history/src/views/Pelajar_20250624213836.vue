            ...
            <div class="relative w-full max-w-full mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <button
                            class="bottom-3 rounded-2xl bg-gradient-to-tr from-blue-300 via-blue-400 to-blue-600 text-white font-bold text-xs px-4 py-1.5 shadow-md hover:from-pink-400 hover:to-blue-700 transition active:scale-95 flex items-center gap-1"
